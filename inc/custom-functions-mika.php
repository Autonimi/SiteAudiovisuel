...
// Appel du script reglage JS carousel
...
wp_enqueue_script( 'script-carousel', get_template_directory_uri() . '/inc/OwlCarousel2-2.3.4/OwlCarousel2-2.3.4/dist/owl.carousel.js', array ( 'jquery' ), 1.0, true);
...
wp_enqueue_style( 'css-produit', get_template_directory_uri() . '/layouts/moncss.css',false,'1.1','all');
